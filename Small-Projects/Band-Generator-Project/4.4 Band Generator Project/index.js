...
app.get("/", (req, res) => {
  res.render("index.ejs", { randomName: "", randomNoun: "" });
});
...
app.post("/submit", (req, res) => {
  ...
  //3. Test to make sure that the random words display in the h1 element in index.ejs
   const randomNameIndex = Math.floor(Math.random() * adj.length);
   const randomnounIndex = Math.floor(Math.random() * noun.length);
   const randomName = adj[randomNameIndex];
   const randomNoun = noun[randomnounIndex];
   res.render("index.ejs",{ randomName:randomName ,randomNoun: randomNoun });
});
